...
const ITEMS: Item[] = [
  ...
  },
  {
    ...
    eyebrow: 'Локація',
    title: 'Ірпінь, Буча, Гостомель, Ворзель, Київ',
    body: 'Бутік в Ірпені, доставка по Бучі, Гостомелю, Ворзелю та ближньому Києву. Локально, з рукою на пульсі.',
    metric: { value: '5 міст', label: 'Зона покриття' },
  },
];
