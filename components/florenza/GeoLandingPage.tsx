  ...
  return (
    <>
      ...
      <section className="editorial-container py-16 max-w-3xl prose-editorial">
        ...
        <h2>Як замовити</h2>
        <p>
          Найшвидший спосіб — написати Лії, нашій AI-консультантці, в Telegram, Viber або в чаті
          праворуч. Лія підбере букет, прийме оплату і повідомить статус доставки. Це 24/7, без
          телефонних дзвінків.
        </p>
