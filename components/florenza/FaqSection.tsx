...
const FAQS: Array<{ q: string; a: string }> = [
  ...
  },
  {
    ...
    a: 'Так. Опишіть привід / отримувача / бюджет у чаті — складемо персональну пропозицію за 30 хвилин. Для весіль і корпоративних подій — окрема форма брифу.',
  },
  {
    q: 'Як платити?',
  ...
  {
    q: 'Чи доставляєте за межі Ірпеню, Бучі, Гостомеля?',
