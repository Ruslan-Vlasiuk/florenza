          ...
          fields: [
            {
              ...
              defaultValue: [
                ...
                { question: 'Чи можна оплатити при доставці?', answer: 'Так, але потрібна часткова передоплата онлайн (10–30% — Варвара рішає). Решта — кур\'єру готівкою або карткою.', tags: ['payment'] },
                { question: 'Чи можна повернути букет?', answer: 'Квіти — швидкопсувний товар, повернення обмежене. Якщо була проблема з якістю — Варвара особисто розберется з компенсацією.', tags: ['returns'] },
          ...
          fields: [
            {
              ...
              type: 'array',
              label: 'Обовʼязкові ескалації (потребують Варвари)',
              fields: [
              ...
              defaultValue: [
                {
                  name: 'Весілля',
                  description: 'Будь-який запит про весілля — обов\'язково Варварі.',
                  keywords: [{ keyword: 'весілля' }, { keyword: 'наречена' }, { keyword: 'весільн' }, { keyword: 'wedding' }],
                  transferMessage: 'Передаю розмову Варварі — для весільних композицій вона підбирає особисто.',
                },
                {
                  ...
                  transferMessage: 'Передаю розмову Варварі — корпоративні запити вона веде особисто.',
                },
                {
                  ...
                  transferMessage: 'Передаю розмову Варварі — у таких випадках вона особисто підбирає композицію.',
                },
                {
                  name: 'Скарга',
                  ...
                  transferMessage: 'Розумію. Передаю розмову Варварі — вона вирішить це особисто.',
                },
                {
                  ...
                  transferMessage: 'Передаю розмову Варварі — це краще обговорити з нею.',
                },
                {
                  ...
                  transferMessage: 'Звичайно, передаю Варварі — вона зв\'яжеться з вами.',
                },
              ],
            },
          ],
