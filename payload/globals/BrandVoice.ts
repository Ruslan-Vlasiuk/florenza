...
export const BrandVoice: GlobalConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      defaultValue: 'Вітаю! Я Лія — AI-консультантка Florenza. Допоможу обрати букет та оформити замовлення. Якщо знадобиться особистий контакт — підключу живу флористку.\n\nЧим можу допомогти?',
    },
    {
      name: 'liyaTransferToHuman',
      type: 'textarea',
      label: 'Передача менеджеру (при ескалації)',
      defaultValue: 'Передаю розмову нашій флористці — вона особисто допоможе.',
    },
    {
