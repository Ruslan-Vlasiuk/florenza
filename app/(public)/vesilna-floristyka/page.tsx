...
export const metadata: Metadata = {
  ...
  description:
    'Весільна флористика від Florenza — Ірпінь, Буча, Київ. Букети нареченої, бутоньєрки, арки, оформлення столів. Подайте бриф — Варвара зв\'яжеться з вами особисто.',
        ...
        <div className="space-y-8">
          ...
          <ol className="space-y-6 text-[var(--color-text-secondary)]">
            ...
            <Step n={2} title="Зустріч / онлайн-консультація">
              Варвара зв&apos;язується з вами особисто протягом доби. Обговорюємо деталі — що зробить
