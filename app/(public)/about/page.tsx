  ...
  return (
    <article>
      ...
      <section className="editorial-container py-16 md:py-24 max-w-3xl prose-editorial">
        ...
        <p>
          Замовлення приймаємо 24/7 у Telegram та в чаті на сайті. Підкажемо з вибором,
          порахуємо суму, оформимо доставку — швидко, у будь-який час. Якщо питання делікатне
          (весілля, складний привід, скарга) — підключаємо живу флористку особисто. Це наша чесна гра:
          швидкість там, де потрібна швидкість, людський контакт там, де він важливий.
        </p>

        <h2>Авторський підхід</h2>
        <p>
          За кожним букетом стоїть жива людина — флористка-засновниця Florenza з понад
          десятирічним досвідом. Власний смак, власні руки, послідовний стиль —
          це читається в кожній композиції.
        </p>
      </section>
