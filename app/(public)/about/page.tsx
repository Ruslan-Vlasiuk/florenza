  ...
  return (
    <article>
      ...
      <section className="editorial-container py-16 md:py-24 max-w-3xl prose-editorial">
        ...
        <h2>AI-консультантка Лія</h2>
        <p>
          Через те, що ми малі, але працюємо 24/7 — ми створили першу в регіоні AI-консультантку
          Лію. Вона приймає замовлення в Telegram, Viber та чаті на сайті в будь-який час,
          допомагає обрати, рахує суми, формує заказы. Якщо тема делікатна — передає Варварі
          особисто. Це наша честна гра: швидкість + людський контакт там, де він потрібен.
        </p>
